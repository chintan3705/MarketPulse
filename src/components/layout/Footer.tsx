        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4">
            ...
            <p className="text-sm text-muted-foreground">
              Your daily lens on the share market. Timely updates, financial insights, and stock analysis.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link href="/advertise" className="text-muted-foreground hover:text-primary transition-colors">Advertise</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><Link href="/category/stocks" className="text-muted-foreground hover:text-primary transition-colors">Stocks</Link></li>
              <li><Link href="/category/ipos" className="text-muted-foreground hover:text-primary transition-colors">IPOs</Link></li>
              <li><Link href="/category/mutual-funds" className="text-muted-foreground hover:text-primary transition-colors">Mutual Funds</Link></li>
              <li><Link href="/category/economy" className="text-muted-foreground hover:text-primary transition-colors">Economy</Link></li>
            </ul>
          </div>
