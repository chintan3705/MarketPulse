...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-lg border bg-card text-card-foreground shadow-sm glass-card", // Added glass-card for glassmorphism
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  // Changed from <p> to <h2> for better semantics, assuming CardTitle is a heading
  <h2 // Changed from 'p'
    ref={ref}
    className={cn(
