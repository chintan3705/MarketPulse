...
export async function generateMetadata(
  ...
  const canonicalUrl = `${SITE_URL}${locale === defaultLocale ? "" : "/" + locale}/disclaimer`;

  const alternatesLang: { [key: string]: string } = {};
  locales.forEach((altLocale) => {
    alternatesLang[altLocale] = `${SITE_URL}${altLocale === defaultLocale ? "" : "/" + altLocale}/disclaimer`;
  });
  ...
  return (
    ...
    >
      ...
      <div className="prose prose-lg dark:prose-invert max-w-none space-y-4">
        ...
        <p>
          <strong>
            The Content on MarketPulse is not intended to be and does not
          ...
          Site. Always seek the advice of a qualified financial advisor or other
          qualified financial service provider with any questions you may have
          regarding your financial situation or investments. Never disregard
          professional financial advice or delay in seeking it because of
        ...
        <p>
          ...
          MarketPulse makes no warranties or representations as to the accuracy,
          completeness, or timeliness of the Content. The financial markets are
          volatile and can change rapidly; therefore, the information on this
          site may not always be current or accurate. We are under no obligation
          to update or correct any information provided on the Site.
        </p>

        <h3 className="font-semibold text-xl mt-5">Investment Risks</h3>
        <p>
          Investing in stock markets, cryptocurrencies, and other financial
          instruments involves a significant risk of loss. Past performance is
          not indicative of future results. The value of investments can go down
          as well as up, and you may not get back the amount you invested.
          MarketPulse is not responsible for any financial losses incurred as a
          result of using or relying on the information provided on this site.
        ...
        <p>
          Some content on MarketPulse, including articles, summaries, and
          images, may be generated with the assistance of artificial
          intelligence (AI) technology. While we strive to ensure the quality
          and relevance of AI-generated content, it may contain errors,
          inaccuracies, or omissions. AI-generated content is provided for
          informational purposes and should not be solely relied upon for making
          financial decisions. All content, whether human-authored or
          AI-assisted, should be viewed critically and verified with other
          sources.
        </p>
        ...
        <p>
          ...
          MarketPulse does not warrant, endorse, guarantee, or assume
          ...
          or feature linked in any banner or other advertising.
        </p>

        <h3 className="font-semibold text-xl mt-5">Views Expressed</h3>
        <p>
          Any views or opinions expressed by authors, contributors, or users on
          MarketPulse are their own and do not necessarily reflect the views of
          MarketPulse as an organization or its editorial team. Content provided
          by third-party contributors is their own responsibility.
        </p>

        <h3 className="font-semibold text-xl mt-5">Affiliate Disclosure</h3>
        <p>
          MarketPulse may, from time to time, participate in affiliate marketing
          programs. This means we may earn a commission if you click on or make
          purchases via affiliate links. This will be at no extra cost to you.
        ...
        <p>
          ...
          or imply its endorsement, recommendation, or favoring by MarketPulse.
        </p>
