...
export async function generateMetadata(
  ...
  const canonicalUrl = `${SITE_URL}${locale === defaultLocale ? "" : "/" + locale}/ipos`;

  const alternatesLang: { [key: string]: string } = {};
  locales.forEach((altLocale) => {
    alternatesLang[altLocale] = `${SITE_URL}${altLocale === defaultLocale ? "" : "/" + altLocale}/ipos`;
  });
...
export default async function IPOsPage({ params: { locale } }: PageProps) {
