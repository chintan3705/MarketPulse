  ...
  return (
    ...
    >
      ...
      <p className='text-lg text-muted-foreground'>
        In-depth market analysis, expert opinions, and detailed reports will be featured here. Stay
        tuned for comprehensive insights to guide your investment decisions.
      </p>
