  ...
  return (
    ...
    >
      ...
      <div className='prose prose-lg dark:prose-invert max-w-none space-y-4'>
        <p>
          Join our passionate team at MarketPulse and help us shape the future of financial news and
          analysis!
        </p>
        <p>
          We are always looking for talented individuals who are enthusiastic about the financial
          markets, journalism, technology, and design. If you are driven, innovative, and want to
          make an impact, MarketPulse could be the place for you.
        </p>

        <h3 className='font-semibold text-xl'>Current Openings</h3>
        <p className='text-muted-foreground'>
          There are currently no open positions. However, we encourage you to check back regularly
          for updates.
        </p>
        ...
        <p>
          If you believe you have the skills and passion to contribute to MarketPulse, feel free to
          send your resume and a cover letter to:{' '}
          <a href='mailto:careers@marketpulse.example.com' className='text-primary hover:underline'>
