  ...
  return (
    ...
    >
      ...
      <div className='prose prose-sm dark:prose-invert max-w-none space-y-4'>
        ...
        <p>
          MarketPulse ("us", "we", or "our") operates the MarketPulse website (the "Service"). This
        ...
        <p>
          ...
          ("Personal Data"). Currently, MarketPulse does not require user registration or directly
          collect personal data like names or email addresses for general browsing. If we introduce
          features like newsletters or user comments in the future, this policy will be updated to
          reflect the data collected (e.g., email address, name).
        </p>
        <p>
        ...
        <p>
          <strong>Tracking & Cookies Data:</strong> We use cookies and similar tracking technologies
          to track the activity on our Service and hold certain information. Cookies are files with
          a small amount of data which may include an anonymous unique identifier. You can instruct
        ...
        <ul className='list-disc list-inside space-y-1'>
          ...
          <li>
            ...
            so (if applicable in the future);
          </li>
        ...
        <p>
          If you are located outside [Your Country/Region - e.g., India] and choose to provide
          information to us, please note that we transfer the data, including Personal Data, to
          [Your Country/Region] and process it there.
        </p>
        <p>
        ...
        <p>
          MarketPulse will take all steps reasonably necessary to ensure that your data is treated
        ...
        <p>
          MarketPulse may disclose your Personal Data in the good faith belief that such action is
          necessary to:
        </p>
        <ul className='list-disc list-inside space-y-1'>
        ...
        <p>
          ...
          parent or guardian and you are aware that your Children has provided us with Personal
        ...
        <p>
          ...
          <a href='mailto:privacy@marketpulse.example.com' className='text-primary hover:underline'>
