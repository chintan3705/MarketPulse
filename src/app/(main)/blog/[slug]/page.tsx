            ...
            <div className="flex-1">
              ...
              {post.isAiGenerated || post.author === "MarketPulse AI" ? (
                <p className="text-sm text-muted-foreground mt-1">
                  This article was generated by MarketPulse AI, providing
                  automated insights and analysis. Our AI is constantly learning
                  to deliver timely and relevant financial information.
                  MarketPulse is committed to editorial oversight of
                  AI-generated content.
                </p>
              ) : (
                <p className="text-sm text-muted-foreground mt-1">
                  {post.author} is a contributor to MarketPulse, offering
                  insights and analysis on financial markets.
