    ...
    <div className="container py-8 md:py-12 animate-slide-in" style={{animationDelay: '0.1s', animationFillMode: 'backwards'}}>
      ...
      <div className="prose prose-sm dark:prose-invert max-w-none space-y-4">
        ...
        <ul className="list-disc list-inside space-y-1">
            ...
            <li>Decipher, decompile, disassemble, or reverse engineer any of fooling software comprising or in any way making up a part of the Site.</li>
        ...
        <p>We cannot guarantee the Site will be available at all times. We may experience hardware, software, or other problems or need to perform maintenance related to the Site, resulting in interruptions, delays, or errors. You agree that we have no liability whatsoever for any loss, damage, or inconvenience caused by your inability to access or use the Site during any downtime or discontinuance of the Site.</p>

        <h3 className="font-semibold text-lg mt-5">8. Governing Law</h3>
        <p>These Terms of Service and your use of the Site are governed by and construed in accordance with the laws of [Your Jurisdiction - e.g., India] applicable to agreements made and to be entirely performed within [Your Jurisdiction], without regard to its conflict of law principles.</p>
        ...
        <p>We may update our Terms of Service from time to time. We will notify you of any changes by posting the new Terms of Service on this page. You are advised to review these Terms of Service periodically for any changes.</p>

        <h3 className="font-semibold text-lg mt-5">13. Contact Us</h3>
        <p>If you have any questions about these Terms, please contact us by email: <a href="mailto:legal@marketpulse.example.com" className="text-primary hover:underline">legal@marketpulse.example.com</a>.</p>
      </div>
    </div>
  );
}
