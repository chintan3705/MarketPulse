    ...
    >
      ...
      <div className='prose prose-sm dark:prose-invert max-w-none space-y-4'>
        ...
        <p>
          ...
          the MarketPulse website (the "Service") operated by MarketPulse ("us", "we", or "our").
        </p>
        <p>
          Your access to and use of the Service is conditioned on your acceptance of and compliance
          with these Terms. These Terms apply to all visitors, users, and others who access or use
          the Service. By accessing or using the Service you agree to be bound by these Terms. If
          you disagree with any part of the terms then you may not access the Service.
        </p>

        <h3 className='font-semibold text-lg mt-5'>1. Intellectual Property Rights</h3>
        <p>
        ...
        <p>
          ...
          agree to comply with these Terms of Service; (2) you are not a minor in the jurisdiction
        ...
        <ul className='list-disc list-inside space-y-1'>
          ...
          <li>
            Decipher, decompile, disassemble, or reverse engineer any of fooling software comprising
        ...
        <h3 className='font-semibold text-lg mt-5'>4. Third-Party Websites and Content</h3>
        <p>
        ...
        <p>
          ...
          discretion, violates the law or these Terms of Service; (3) in our sole discretion and
          without limitation, refuse, restrict access to, limit the availability of, or disable (to
          the extent technologically feasible) any of your Contributions or any portion thereof; (4)
        ...
        <p>
          ...
          CONTAINED IN THESE TERMS OF SERVICE OR OF ANY APPLICABLE LAW OR REGULATION. WE MAY
          TERMINATE YOUR USE OR PARTICIPATION IN THE SITE OR DELETE ANY CONTENT OR INFORMATION THAT
          YOU POSTED AT ANY TIME, WITHOUT WARNING, IN OUR SOLE DISCRETION.
        </p>

        <h3 className='font-semibold text-lg mt-5'>7. Modifications and Interruptions</h3>
        <p>
        ...
        <p>
          ...
          in interruptions, delays, or errors. You agree that we have no liability whatsoever for
        ...
        <p>
          ...
          accordance with the laws of [Your Jurisdiction - e.g., India] applicable to agreements
          made and to be entirely performed within [Your Jurisdiction], without regard to its
        ...
        <p>Please also review our dedicated Disclaimer page for further details.</p>

        <h3 className='font-semibold text-lg mt-5'>10. Limitation of Liability</h3>
        <p>
        ...
        <p>
          ...
          (2) breach of these Terms of Service; (3) any breach of your representations and
          warranties set forth in these Terms of Service; (4) your violation of the rights of a
        ...
        <h3 className='font-semibold text-lg mt-5'>12. Changes to These Terms of Service</h3>
        <p>
          We may update our Terms of Service from time to time. We will notify you of any changes by
          posting the new Terms of Service on this page. You are advised to review these Terms of
          Service periodically for any changes.
        </p>
