  ...
  return (
    ...
    >
      ...
      <div className='prose prose-lg dark:prose-invert max-w-none space-y-4'>
        <p>
          We'd love to hear from you! Whether you have a question, feedback, or a news tip, please
        ...
        <p>
          ...
          <a href='mailto:info@marketpulse.example.com' className='text-primary hover:underline'>
        ...
        <p>
          ...
          <a href='mailto:editor@marketpulse.example.com' className='text-primary hover:underline'>
