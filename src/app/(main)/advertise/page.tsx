  ...
  return (
    <div className="container py-8 md:py-12 animate-slide-in" style={{animationDelay: '0.1s', animationFillMode: 'backwards'}}>
      ...
      <div className="prose prose-lg dark:prose-invert max-w-none space-y-4">
        <p>Reach a highly engaged audience of investors, financial enthusiasts, and market professionals by advertising with MarketPulse.</p>
        <p>We offer a variety of advertising solutions to help you connect with our readers, including:</p>
        ...
        <p>Our platform provides an excellent opportunity to showcase your brand, products, or services to individuals actively seeking financial information and investment opportunities.</p>
        <p>For more information on our advertising packages and to discuss your specific needs, please contact our advertising team at: <a href="mailto:ads@marketpulse.example.com" className="text-primary hover:underline">ads@marketpulse.example.com</a>.</p>
